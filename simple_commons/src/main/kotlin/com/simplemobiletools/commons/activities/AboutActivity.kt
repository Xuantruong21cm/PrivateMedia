...
class AboutActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateMaterialActivityViews(
            mBinding.aboutCoordinator,
            mBinding.aboutHolder,
            useTransparentNavigation = true,
            useTopSearchMenu = false
        )
        setupMaterialScrollListener(mBinding.aboutNestedScrollview, mBinding.aboutToolbar)

        appName = intent.getStringExtra(APP_NAME) ?: ""

        arrayOf(
            mBinding.aboutSupport,
            mBinding.aboutHelpUs,
            mBinding.aboutSocial,
            mBinding.aboutOther
        ).forEach {
    ...
    override fun onResume() {
        super.onResume()
        updateTextColors(mBinding.aboutNestedScrollview)
        setupToolbar(mBinding.aboutToolbar, NavigationIcon.Arrow)

        mBinding.aboutSupportLayout.removeAllViews()
        mBinding.aboutHelpUsLayout.removeAllViews()
        mBinding.aboutSocialLayout.removeAllViews()
        mBinding.aboutOtherLayout.removeAllViews()
    ...
    private fun setupFAQ() {
        ...
        if (faqItems.isNotEmpty()) {
            inflater?.inflate(R.layout.item_about, null)?.apply {
                setupAboutItem(
                    this,
                    R.drawable.ic_question_mark_vector,
                    R.string.frequently_asked_questions
                )
                mBinding.aboutSupportLayout.addView(this)
    ...
    private fun setupEmail() {
        if (resources.getBoolean(R.bool.hide_all_external_links)) {
            if (mBinding.aboutSupportLayout.isEmpty()) {
                mBinding.aboutSupport.beGone()
                mBinding.aboutSupportDivider.beGone()
            }
    ...
    private fun setupRateUs() {
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            ...
            mBinding.aboutHelpUsLayout.addView(this)
    ...
    private fun setupFacebook() {
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            findViewById<ImageView>(R.id.about_item_icon).setImageResource(R.drawable.ic_facebook_vector)
            findViewById<TextView>(R.id.about_item_label).setText(R.string.facebook)
            findViewById<TextView>(R.id.about_item_label).setTextColor(textColor)
            mBinding.aboutSocialLayout.addView(this)
    ...
    private fun setupGitHub() {
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            findViewById<ImageView>(R.id.about_item_icon).setImageDrawable(
                resources.getColoredDrawableWithColor(
                    R.drawable.ic_github_vector,
                    backgroundColor.getContrastColor()
                )
            )
            findViewById<TextView>(R.id.about_item_label).setText(R.string.github)
            findViewById<TextView>(R.id.about_item_label).setTextColor(textColor)
            mBinding.aboutSocialLayout.addView(this)
    ...
    private fun setupReddit() {
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            findViewById<ImageView>(R.id.about_item_icon).setImageResource(R.drawable.ic_reddit_vector)
            findViewById<TextView>(R.id.about_item_label).setText(R.string.reddit)
            findViewById<TextView>(R.id.about_item_label).setTextColor(textColor)
            mBinding.aboutSocialLayout.addView(this)
    ...
    private fun setupTelegram() {
        if (resources.getBoolean(R.bool.hide_all_external_links)) {
            if (mBinding.aboutSupportLayout.isEmpty()) {
                mBinding.aboutSocial.beGone()
                mBinding.aboutSocialDivider.beGone()
            }
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            findViewById<ImageView>(R.id.about_item_icon).setImageResource(R.drawable.ic_telegram_vector)
            findViewById<TextView>(R.id.about_item_label).setText(R.string.telegram)
            findViewById<TextView>(R.id.about_item_label).setTextColor(textColor)
            mBinding.aboutSocialLayout.addView(this)
    ...
    private fun setupMoreApps() {
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            ...
            mBinding.aboutOtherLayout.addView(this)
    ...
    private fun setupVersion() {
        ...
        inflater?.inflate(R.layout.item_about, null)?.apply {
            findViewById<ImageView>(R.id.about_item_icon).setImageDrawable(
                resources.getColoredDrawableWithColor(
                    R.drawable.ic_info_vector,
                    textColor
                )
            )
            val fullVersion = String.format(getString(R.string.version_placeholder, version))
            findViewById<TextView>(R.id.about_item_label).text = fullVersion
            findViewById<TextView>(R.id.about_item_label).setTextColor(textColor)
            mBinding.aboutOtherLayout.addView(this)
    ...
    private fun setupAboutItem(view: View, drawableId: Int, textId: Int) {
        view.apply {
            ...
            findViewById<TextView>(R.id.about_item_label).setText(textId)
            findViewById<TextView>(R.id.about_item_label).setTextColor(textColor)
        }
    }
}
