package com.joysoftgo.privatemedia.helpers
...
import com.joysoftgo.privatemedia.model.ThumbnailSection
...
class MediaFetcher(val context: Context) {
    ...
    fun groupMedia(media: ArrayList<Medium>, path: String): ArrayList<ThumbnailItem> {
        ...
        for ((key, value) in mediumGroups) {
            ...
            thumbnailItems.addAll(listOf(value as ThumbnailItem))
        }
        return thumbnailItems
    }
